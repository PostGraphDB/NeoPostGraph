...
CREATE FUNCTION drop_vlabel(graph_name Name, label text)
RETURNS void 
LANGUAGE c 
AS 'MODULE_PATHNAME';
...
CREATE FUNCTION set_vertex_label(vertex_id bigint, label_id integer, graph_id integer, label_name text)
RETURNS vertex
LANGUAGE c
...
CREATE FUNCTION alter_graph(graph_name Name, new_namespace text, namespace text DEFAULT NULL)
RETURNS void
LANGUAGE c
AS 'MODULE_PATHNAME';
