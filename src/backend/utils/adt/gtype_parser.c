...
typedef enum /* contexts of gtype parser */
{
    GTYPE_PARSE_VALUE,
    GTYPE_PARSE_STRING,
    GTYPE_PARSE_ARRAY_START,
    GTYPE_PARSE_ARRAY_NEXT,
    GTYPE_PARSE_OBJECT_START,
    GTYPE_PARSE_OBJECT_LABEL,
    GTYPE_PARSE_OBJECT_NEXT,
    GTYPE_PARSE_OBJECT_COMMA,
    GTYPE_PARSE_END
} gtype_parse_context;

static void gtype_lex(gtype_lex_context *lex);
static void gtype_lex_string(gtype_lex_context *lex);
static void gtype_lex_number(gtype_lex_context *lex, char *s, bool *num_err, int *total_len);
static void parse_scalar_annotation(gtype_lex_context *lex, void *func, char **annotation);
static void parse_scalar(gtype_lex_context *lex, gtype_sem_action *sem);
...
*/
static gtype_token_type lex_peek(gtype_lex_context *lex) {
 ...
 */
static bool lex_accept(gtype_lex_context *lex, gtype_token_type token, char **lexeme) {
 ...
 */
static void lex_expect(gtype_parse_context ctx, gtype_lex_context *lex, gtype_token_type token) {
